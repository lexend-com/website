...
import { Flex, Left, Right, Section, Intro, Quote, Banner, Button, Link, Extension } from "../components";
...
<Extension  background="static/images/travis.jpg" details="Change the font of any website with the new Lexend Chrome extension, powered by Helperbird." header="Get the Lexend extension" title="Photo by Thought Catalog (unsplash.com/@thoughtcatalog)">
